        ...
        <div className="max-w-4xl mx-auto fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="text-center">
              ...
              <p className="text-gray-400">Get your project up and running in as little as 2 weeks</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">Competitive rates with transparent pricing models</p>
            </div>
